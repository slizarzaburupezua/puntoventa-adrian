...
export const courses = [
    ...
    },
    {
        ...
        title      : 'Personalize Your iOS App with Firebase userInfoLogueado Management',
        slug       : 'personalize-your-ios-app-with-firebase-userInfoLogueado-management',
        description: 'Dive deep into userInfoLogueado Management on iOS apps using Firebase',
        category   : 'firebase',
        duration   : 90,
        totalSteps : 11,
...
export const demoCourseSteps = [
    ...
    {
        order   : 7,
        title   : 'Welcome New userInfoLogueados',
        subtitle: 'How to create a welcome message for the new userInfoLogueados',
        content : `<h2 class="text-2xl sm:text-3xl">Welcome New userInfoLogueados</h1> ${demoCourseContent}`,
    },
    {
        order   : 8,
    ...
    },
    {
        ...
        subtitle: 'How to create and push a notification to a userInfoLogueado',
