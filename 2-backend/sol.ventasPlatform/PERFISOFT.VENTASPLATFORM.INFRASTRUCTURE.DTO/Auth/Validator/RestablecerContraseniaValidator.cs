...
{
    public class RestablecerContraseniaValidator : AbstractValidator<RestablecerContraseniaRequest>
    {
        public RestablecerContraseniaValidator()
        {
            Log.Information("Iniciando validación Request RestablecerContraseniaRequest");
            ...
            RuleFor(x => x.Token)
                .NotNull().WithMessage(GV.PropertyNameNotNull)
                .NotEmpty().WithMessage(GV.PropertyNameNotEmpty)
                .MinimumLength(Numeracion.Cinco).WithMessage(GV.PropertyNameNotEmpty);
            ;
        ...
        public override ValidationResult Validate(ValidationContext<RestablecerContraseniaRequest> context)
        {
