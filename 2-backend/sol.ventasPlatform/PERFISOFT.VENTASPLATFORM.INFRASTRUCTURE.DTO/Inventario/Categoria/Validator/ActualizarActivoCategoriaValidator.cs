...
{
    public class ActualizarActivoCategoriaValidator : AbstractValidator<ActualizarActivoCategoriaRequest>
    {
        public ActualizarActivoCategoriaValidator()
        {
            Log.Information("Iniciando validación Request ActualizarActivoCategoriaValidator");
        ...
        public override ValidationResult Validate(ValidationContext<ActualizarActivoCategoriaRequest> context)
        {
