...
{
    public class ActualizarMarcaValidator : AbstractValidator<ActualizarMarcaRequest>
    {
        public ActualizarMarcaValidator()
        {
            Log.Information("Iniciando validación Request ActualizarMarcaValidator");
        ...
        public override ValidationResult Validate(ValidationContext<ActualizarMarcaRequest> context)
        {
