...
{
    public class ObtenerMarcaValidator : AbstractValidator<ObtenerMarcaRequest>
    {
        public ObtenerMarcaValidator()
        {
            Log.Information("Iniciando validación Request ObtenerMarcaRequest");
        ...
        public override ValidationResult Validate(ValidationContext<ObtenerMarcaRequest> context)
        {
