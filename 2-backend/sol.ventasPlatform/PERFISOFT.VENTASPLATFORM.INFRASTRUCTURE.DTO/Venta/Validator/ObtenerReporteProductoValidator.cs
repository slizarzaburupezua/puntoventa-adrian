...
{
    public class ObtenerReporteProductoValidator : AbstractValidator<ObtenerReporteProductoRequest>
    {
        public ObtenerReporteProductoValidator()
        {
            Log.Information("Iniciando validación Request ObtenerReporteProductoRequest");
        ...
        public override ValidationResult Validate(ValidationContext<ObtenerReporteProductoRequest> context)
        {
