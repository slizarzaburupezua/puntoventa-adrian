...
{
    public class ObtenerVentaValidator : AbstractValidator<ObtenerVentaRequest>
    {
        public ObtenerVentaValidator()
        {
            Log.Information("Iniciando validación Request ObtenerVentaRequest");
            ...
            RuleFor(x => x.NumeroVenta)
                .MaximumLength(Numeracion.Veinte).WithMessage(GV.PropertyNameCorrectLenght);
        ...
        public override ValidationResult Validate(ValidationContext<ObtenerVentaRequest> context)
        {
