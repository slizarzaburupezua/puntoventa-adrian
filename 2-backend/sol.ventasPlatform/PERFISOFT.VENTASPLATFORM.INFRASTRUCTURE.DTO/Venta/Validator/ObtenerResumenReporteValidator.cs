...
{
    public class ObtenerResumenReporteValidator : AbstractValidator<ObtenerResumenReporteRequest>
    {
        public ObtenerResumenReporteValidator()
        {
            Log.Information("Iniciando validación Request ObtenerResumenReporteRequest");
        ...
        public override ValidationResult Validate(ValidationContext<ObtenerResumenReporteRequest> context)
        {
