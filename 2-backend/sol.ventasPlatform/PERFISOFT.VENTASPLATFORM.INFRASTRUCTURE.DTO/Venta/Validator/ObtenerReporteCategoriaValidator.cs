...
{
    public class ObtenerReporteCategoriaValidator : AbstractValidator<ObtenerReporteCategoriaRequest>
    {
        public ObtenerReporteCategoriaValidator()
        {
            Log.Information("Iniciando validación Request ObtenerReporteCategoriaRequest");
        ...
        public override ValidationResult Validate(ValidationContext<ObtenerReporteCategoriaRequest> context)
        {
